...
//
//	client.User.Query().
//		GroupBy(user.FieldMobileNumber).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withOrders; query != nil {
		if err := uq.loadOrders(ctx, query, nodes, nil,
			func(n *User, e *Order) { n.Edges.Orders = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
